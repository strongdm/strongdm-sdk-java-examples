...
public class DeleteApprovalWorkflowApproverRole {
    public static void main(String[] args) {
        ...
        try {
            ...
            client.approvalWorkflowApprovers().delete(approver.getId());
            
            System.out.println("Successfully deleted approval workflow approver.");
        } catch (Exception e) {
            e.printStackTrace();
        }
